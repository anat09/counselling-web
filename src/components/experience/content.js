...
export const second = [
  ...
  confidential space for clients to explore what is occurring for them in the here and now, as well as
  what has or has not worked out so far in looking after themselves. I also conduct comprehensive
  mental health and risk assessments with clients, to establish the best therapeutic approach suitable
  for them going forward, given their emotional, psychological needs.`,
...
export const third = [
  ...
  in therapy (as you will see below), allowing me to deliver counselling and psychotherapy in an
...
export const fourth = [
  ...
  <TickList list={[
    ...
    Suicidal Ideation, Self-Harm, Building Trust, Anxiety, Procrastination, Multilingual Clients;`,
