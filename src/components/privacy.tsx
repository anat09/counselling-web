...
const Privacy = () => {
  return (
    <><SubHeader title='Privacy Policy' />
      <SubHeader title="How I obtain personal information and reasons to do so" />
      <Section paras={[
        `I will use the information that you have provided in order for
      ...
      <Section paras={[
        ...
        by me in response to your query. If you do not respond to any
        ...
        secure. Although I will do my best to protect your information
        using industry-standard protocols and encryption,I cannot guarantee the security of
        your data transmitted to me via email, including forms completed on this website; any
        transmission is at your own risk. Once I have received your
      ...
      <Section paras={[
        ...
        you think is inaccurate. You also have the right to ask me to
        complete information you think is incomplete.</>,
        <><span className="text-primary font-bold">Right to erasue</span> - You have the right to ask me to erase
        your personal information in certain circumstances.</>,
        <><span className="text-primary font-bold">Right to restriction of processing</span> - You have the right to ask me to restrict the 
        ...
        your personal information in certain circumstances.</>,
        <><span className="text-primary font-bold">Right to data portability</span> - You have the right to ask that I
        ...
        request, please do so by emailing me, and I will have one calendar month to respond to you.</>
      ]} />
    </>
  )
}
