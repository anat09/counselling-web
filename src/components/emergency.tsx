  ...
  return (
    <>
      ...
      <Section paras={[`Counselling is a type of talking therapy that can support you when you are not in
          immediate danger to yourself or to/from others. If the above crisis signposting does not apply to how you are currently feeling, and you are looking for counselling support, please do not hesitate to get in touch with me, by completing the form below.`]} />
    </>
  )
}