  ...
  return (
    <>
      ...
      <Section paras={[
        ...
        information is provided by me, Anamaria Tigan, and while I endeavour to keep the
        ...
        `Through this website you can link to other websites which are not under my control. I have no control over the nature, content and availability of
        those sites. These websites are included for information purposes only. The inclusion of any links does not necessarily imply a recommendation or
        endorse the views expressed within them.`,
      ]} />
      <SubHeader title='Changes to any of the above' />
      <Section paras={[
        `I, Anamaria Tigan, reserve the rights to edit these policies from time to time. If
