...
export const firstParas = [
  ...
  `This website will hopefully give you an idea about how I work as a counsellor and whether we
  could work together. If you would like to get in touch to book a first initial consultation, or if
...
export const secondParas = [
  ...
  `Our counselling sessions will be guided by what brings you to therapy, and I look forward to
